        ...
        <div className="p-[10px]">
            <div className="w-full lg:w-max lg:h-[960px] flex lg:flex-col justify-between relative items-center bg-[#161D2F] p-4 rounded-[15px]">
                <div className="w-[100%] lg:w-max flex lg:flex-col items-center gap-0 lg:gap-[40px]">
                    ...
                    <div className="flex lg:flex-col pt-0 lg:pt-[25px] gap-5 lg:gap-[30px] m-auto">
                        <NavLink 
                            to='/home' 
                            >
                            {({ isActive }) => (
                                <svg width="20" height="20" viewBox="0 0 20 20" fill={isActive ? "#fff" : "#5a698f"} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <NavLink 
                            ...
                            >
                            {({ isActive }) => (
                                <svg width="17" height="20" viewBox="0 0 17 20" fill={isActive ? "#fff" : "#5a698f"} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <img src={logout} className="cursor-pointer w-7" onClick={removeStorage} alt="logout" />
            </div>
        </div>
    )
}
