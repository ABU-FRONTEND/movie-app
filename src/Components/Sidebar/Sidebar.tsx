...
export default function Sidebar() {
  ...
  return (
    <div className=" p-[10px]">
        <div className="w-full lg:w-max lg:h-[960px] flex lg:flex-col justify-between  items-center bg-[#161D2F] p-4 rounded-[15px]">
            <div className="w-[100%] lg:w-max flex lg:flex-col items-center gap-0 lg:gap-[40px] ">
                ...
                <Link to={'/bookmarks'} onClick={() => handleActive(4)}>
            ...
            <div className="w-10 h-10 rounded-full bg-[#fff] xl:self-end">
