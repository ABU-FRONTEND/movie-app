...
const NotFound = () => {
  return (
<div className="flex items-center w-full justify-center min-h-screen bg-cover bg-center bg-no-repeat"
style={{ backgroundImage: "url('https://source.unsplash.com/random/1920x1080?nature')" }}>

  <div className="max-w-md mx-auto text-center bg-transparent bg-opacity-90 p-8 rounded-lg shadow-lg">
    ...
    <Link to={"/home"}
      className="inline-block bg-indigo-600 text-white font-semibold px-6 py-3 rounded-md hover:bg-indigo-700 transition-colors duration-300">Go Back Home</Link>
  </div>
</div>
